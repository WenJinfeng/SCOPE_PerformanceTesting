...
class Sample:
    ...
    def invoke_function():
        ...
        body_stream = StreamClient.read_from_string('{"index": 10}') # input
    ...
    def main(args: List[str],) -> None:
        ...
        for i in range(500):
            ...
            line = f"Function-Name:alifunctionfib, status:cold, End-to-end-Time:{cold_time}, status:warm, End-to-end-Time:{warm_time}\n"
